...
La estrategia general de la asignatura se basa en el aprendizaje significativo, por lo que, partiendo de experiencias comunicativas cercanas —conocimiento de la prensa escrita (contexto experiencial)—, se propicia plantear preguntas y reflexionar sobre la adecuación de la selección de los hechos informativos y de su tratamiento (observación reflexiva) en la unidad 1, de tal modo que, una vez desarrollados y asimilados junto con la profesora (conceptualización) a lo largo de todas las unidades, el alumnado sea capaz de elaborar el texto periodístico correspondiente conforme a las características del género en cuestión y utilizando los medios técnicos adecuados (experimentación activa) en las unidades 2, 3 y 4.
...
1. **Recapitulación** (individual y/o en grupos)<!-- , 30min -->: Refrescar las anotaciones del trabajo preparatorio, ultimar los detalles del análisis. 
1. **Lectura en voz alta**<!-- , 20min -->: Realizar una lectura en voz alta del texto y una puesta en común de las impresiones generales. 
1. **Análisis conjunto del texto**<!-- , 1h -->: Diseccionar y analizar el texto, toda la clase conjuntamente.
1. **Cierre**<!-- , 10min -->: Se decidirá por sorteo qué grupos entregarán por escrito el análisis del texto comentado. El plazo de entrega de este informe con el análisis será de una semana.  
...
A diferencia de los textos periodísticos de elaboración propia, no hay opción de revisar y volver a entregar el análisis de texto<!-- , ni en la convocatoria ordinaria ni extraordinaria -->.
...
5. **REPASAR**, repasar y repasar
  <small>Dejar “reposar” el texto y dárselo a otra persona para que lo lea y valore; escuchar sus sugerencias</small>
